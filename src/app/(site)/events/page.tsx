  ...
  return (
    <main className='flex-1 flex flex-col items-center pb-24 pt-8 md:pt-12 relative overflow-hidden'>
      ...
      <div className='container-fluid w-full max-w-7xl'>
        {/* HERO SECTION */}
        <section className='bg-primary border-4 border-primary rounded-3xl p-8 md:p-16 shadow-[8px_8px_0px_0px_#dba58a] relative overflow-hidden mb-20 text-white'>
          {/* Internal card decorations */}
          <div className='absolute -right-10 -top-10 w-48 h-48 bg-accent-orange rounded-full blur-xl opacity-50'></div>
          <div className='absolute -left-10 -bottom-10 w-48 h-48 bg-accent-peach rounded-full blur-xl opacity-30'></div>
          ...
          <div className='relative z-10 flex flex-col md:flex-row items-center justify-between gap-8'>
            <div className='text-center md:text-left flex-1'>
              <div className='inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-accent-orange border-2 border-primary text-white font-bold font-display mb-6 shadow-[4px_4px_0px_0px_#162836] rotate-2'>
                ...
                <span>Kumpul & Main Bareng</span>
              </div>
              
              <h1 className='font-display text-5xl md:text-7xl lg:text-8xl font-black leading-[0.9] tracking-tight mb-6 uppercase'>
                PLAYDAY
                <br />
                <span className='inline-block transform -rotate-2 bg-white text-primary border-4 border-primary shadow-[6px_6px_0px_0px_#cf7650] px-6 py-2 mt-4'>
                  & EVENT
                </span>
              </h1>
              <p className='text-xl md:text-2xl font-bold text-white/80 max-w-xl mt-8'>
                Jadwal playday rutin, turnamen, dan kumpul seru penggemar board game se-Kota Mataram. Kosongin jadwalmu!
              </p>
            </div>

            <div className='hidden md:flex relative'>
              <div className='absolute inset-0 bg-accent-peach border-4 border-primary rounded-3xl transform rotate-6 translate-x-4 translate-y-4'></div>
        ...
        {events.length === 0 ? (
          <div className='w-full bg-white border-4 border-primary rounded-3xl p-20 flex flex-col items-center justify-center text-center shadow-[8px_8px_0px_0px_#162836]'>
            ...
            <p className='text-xl text-primary/60 font-medium max-w-md'>
              Belum ada event dalam waktu dekat nih. Pantau terus Instagram kita ya buat info playday selanjutnya! 😢
            </p>
          </div>
        ) : (
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12'>
            {events.map((event: any) => {
              ...
              return (
                ...
                >
                  <div className='relative w-full aspect-[4/3] border-b-[4px] border-primary overflow-hidden rounded-t-[12px] bg-primary/5 box-border'>
                    {event.image ? (
                      <Image
                  ...
                  <div className='p-6 flex-1 flex flex-col justify-between bg-white rounded-b-[12px]'>
                    <div>
                      ...
                      <div className='space-y-4 font-bold text-primary/80 mt-6 pt-4 border-t-2 border-primary/10'>
                        {event.date && (
                          <div className='flex items-center text-sm'>
                            <div className='w-8 h-8 rounded-full bg-accent-peach/20 border-2 border-primary flex items-center justify-center mr-3 flex-shrink-0'>
